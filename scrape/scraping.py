...
def extract_website(website_base_url):
    ...
    Returns:
        dict: A dictionary containing the website base URL as key and the value as another dictionary conatining webpages within the base url as key and values as the dictionary returned by `extract_webpage(webpage_url)` function.
    """
